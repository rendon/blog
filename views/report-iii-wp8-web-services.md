"=========== Meta ============
"StrID : 875
"Title : Reporte III: Web service con aplicación Windows Phone 8 como cliente
"Slug  : report-iii-wp8-web-services
"Cats  : 
"Tags  : 
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1590-vimpress_5278772d_mkd.txt
"========== Content ==========
...
- **Synchronize(clients[], requests[], details[])** Recibe los datos de la aplicación móvil y realiza la sincronización.
- **GetAllClients()** Retorna al cliente la lista de clientes. Este servicio forma parte de la sincronización.
- **GetAllRequests()** Retorna al cliente la lista de peticiones. Este servicio forma parte de la sincronización.
- **GetAllDetails()** Retorna al cliente la lista de detalles de cada petición. Este servicio forma parte de la sincronización.
...
[php]figure('ws_wp8_01', 'El modelo de datos', 'ws_wp8_01', 'png', 'ES');[/php]
...
[php]subsection('Synchronize');[/php]
...
[php]subsection('GetAllClients');[/php]
...
[php]subsection('GetAllRequests');[/php]
...
[php]subsection('GetAllDetails');[/php]
...
- **Client** Representa a la tabla Cliente (o sea, obvio :) )
- **Request** Representa a la table Pedido.
- **Detail** Representa a la tabla Detalle.
- **Key** Tabla auxiliar para almacenar las claves primarias de las tablas restantes.
...
[php]figure('ws_wp8_02', 'Nuestro proyecto en el Explorador de soluciones', 'ws_wp8_02', 'png', 'ES');[/php]
...
[php]subsection('Conexión al Web service');[/php]
...
[php]figure('ws_wp8_03', 'Conexión al Web service', 'ws_wp8_03', 'png', 'ES');[/php]


[php]subsection('La pagina principal');[/php]

La siguiente imagen muestra la pagina principal de la aplicación:

[php]figure('ws_wp8_04', 'Pagina principal', 'ws_wp8_04', 'png', 'ES');[/php]
...
[php]subsection('Alta de clientes');[/php]

La siguiente imagen muestra la interfaz para dar de alta a los clientes.

[php]figure('ws_wp8_05', 'Alta de clientes', 'ws_wp8_05', 'png', 'ES');[/php]
...
[php]subsection('Consulta de Clientes');[/php]

La siguiente imagen muestra la interfaz para la consulta de clientes.

[php]figure('ws_wp8_06', 'Consulta de clientes', 'ws_wp8_06', 'png', 'ES');[/php]
...
[php]figure('ws_wp8_07', 'Consulta de clientes', 'ws_wp8_07', 'png', 'ES');[/php]
...
[php]figure('ws_wp8_08', 'Consulta de pedidos', 'ws_wp8_08', 'png', 'ES');[/php]
...
[php]subsection('La sincronización con el servidor');[/php]
