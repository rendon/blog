"=========== Meta ============
"StrID : 289
"Title : Game controller with Arduino
"Slug  : arduino-game-controller
"Cats  : Sin categoría
"Tags  : 
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1407-vimpress_537827db_mkd.txt
"========== Content ==========
[php]set_setting("show_numbers_in_sections", false);[/php]

Hi guys!, In my <a href="/arduino-control-speakers/" target="_blank">previous post</a> I described how to build a volume controller with Arduino, using the <strong>termios</strong> API for serial communication in GNU/Linux, well, in this post I use the same concepts to build a simple game controller for the classical game Snake.

[php]section("Let's get started");[/php]

We need to build the following circuit:

[php]figure('game1', 'Schematic', 'game1', 'jpg', 'EN');[/php]

[php]figure('game2', 'Electronic diagram', 'game2', 'jpg', 'EN');[/php]
...
[php]figure('game3', 'Game in action', 'game3', 'jpg', 'EN');[/php]
