"=========== Meta ============
"StrID : 971
"Title : OMI Training Gate: Sumando sumas (SUMSUMS)
"Slug  : omi-tg-sumando-sumas
"Cats  : Sin categoría
"Tags  : 
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid972-vimpress_52b5daf8_mkd.txt
"========== Content ==========
El día de hoy estuve resolviendo <a href="http://www.cmirg.com:8081/traingate/visualiza.php?task=sumsums" target="_blank">este problema</a> (o en <a href="http://www.spoj.com/problems/SUMSUMS/" target="_blank">SPOJ</a>) y les quiero compartir mi solución y un poco del análisis para poder resolverlo.
