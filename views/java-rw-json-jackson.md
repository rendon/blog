"=========== Meta ============
"StrID : 1682
"Title : Read and Write JSON with Jackson in Java
"Slug  : java-rw-json-jackson
"Cats  : Sin categoría
"Tags  : 
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1687-vimpress_5406a3bd_mkd.txt
"========== Content ==========

I'm working on my <a href="https://github.com/rendon/graph_illustrator/" target="_blank">graph tool</a> and I just changed the file format to JSON, then the need to read and write JSON from and to a file.
