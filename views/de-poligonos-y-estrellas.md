"=========== Meta ============
"StrID : 78
"Title : De poligonos y estrellas
"Slug  : de-poligonos-y-estrellas
"Cats  : Sin categoría
"Tags  : 
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1434-vimpress_5377b1c2_mkd.txt
"========== Content ==========
[php]initialize();[/php]
...
[php]figure('coordenadas_polares', 'Coordenadas polares', 'coordenadas_polares', 'png', 'ES');[/php]
...
[php]figure('coordenadas_java', 'Sistema de coordenadas en Java', 'coordenadas_java', 'png', 'ES');[/php]
