"=========== Meta ============
"StrID : 915
"Title : Reporte V: Web service con aplicación Android como cliente
"Slug  : report-v-android-web-service
"Cats  : Sin categoría
"Tags  : 
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1616-vimpress_5288464f_mkd.txt
"========== Content ==========
...
[php]figure('bbws_data_model', 'Modelo de datos', 'bbws_data_model', 'png', 'ES');[/php]

Lo relevante de la implementación del Web service lo pueden encontrar en los reportes <a href="/report-iii-wp8-web-services/">III</a> y <a href="/report-iv-bb10-web-service/">IV</a>, colocar nuevamente el código aquí sería redundante y ocuparía mucho espacio.
...
[php]figure('androidws_cp_1', 'Página de inicio de IntelliJ IDEA', 'androidws_cp_1', 'png', 'ES');[/php]
[php]figure('androidws_cp_2', 'Nombre del proyecto', 'androidws_cp_2', 'png', 'ES');[/php]
[php]figure('androidws_cp_3', 'Nombre del paquete y configuración de dispositivo', 'androidws_cp_3', 'png', 'ES');[/php]
[php]figure('androidws_cp_4', 'Estamos listos para empezar', 'androidws_cp_4', 'png', 'ES');[/php]

[php]subsection('La página principal'); [/php]

La siguiente figura muestra como lucirá la página principal de nuestra aplicación:

[php]figure('androidws_home', 'Página principal', 'androidws_home', 'png', 'ES');[/php]
...
[php]figure('androidws_shop', 'Registro de pedidos', 'androidws_shop', 'png', 'ES');[/php]
...
[php]figure('androidws_query', 'Consulta de pedidos', 'androidws_query', 'png', 'ES');[/php]
...
<a href="https://bitbucket.org/rendon/requisitionandroid" target="_blank">https://bitbucket.org/rendon/requisitionandroid</a>
