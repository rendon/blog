...
"EditType   : post
"EditFormat : markdown
"TextAttach : vimpress_5377bf23_mkd.txt
"========== Content ==========
[php]initialize();[/php]

Hi! Welcome to my first post in English :).

Today was held the first World Finals Warmup 2012 and I was reading(don't solving) the problems and I found a very interesting fact in <a href="http://uva.onlinejudge.org/contests/296-e6f9c1dc/12437.html">problem E</a>, Good Words, and well that is what I'll write in this post.
