"=========== Meta ============
"StrID : 56
"Title : ProjectEuler: Problema 1
"Slug  : projecteuler-problema-1
"Cats  : Algoritmos,Matemática,Programación
"Tags  : c++ set, divisores, projecteuler
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1237-vimpress_5377a41a_mkd.txt
"========== Content ==========
[php]initialize();[/php]
...
Versión original: <a href="http://projecteuler.net/index.php?section=problems&id=1">Problem 1</a>


#Análisis
Lo primero que es necesario identificar  es que se  nos esta pidiendo. Nuestra tarea consiste en encontrar todos aquellos números enteros en el rango de 1 a 999 que sean divisibles ya sea por 3 ó bien por 5, es decir, aquellos números que tienen división exacta con estos dos números. O bien, en otras palabras, para todo numero 1<= i < 1000, <i>i <b>mod</b> 3 = 0</i> o <i>i <b>mod</b> 5 = 0</i>, donde <b>mod</b> corresponde al residuo de una división entera.
...
En la segunda implementación he usado la clase <code>set</code> de C++ con dos propósitos: facilitar la implementación y para que aquellos que no la conozcan puedan empezar a ver su utilidad. Hasta la próxima.
