...
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1728-wpid-vimpress_538ea7b0_mkd.txt
"========== Content ==========
[php]section("Introduction");[/php]
...
This is the paper <a href="/files/AhoCorasick.pdf" target="_blank">Efficient String Matching: An Aid to Bibliographic Search</a>
    
Usually these papers are very complex and hard to understand without enough background but for my surprise, this one is well explained and easy to understand.

[php]section("Aho-Corasick implementation in C++");[/php]
...
[php]section("Practice problems");[/php]
