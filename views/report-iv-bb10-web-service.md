"=========== Meta ============
"StrID : 888
"Title : Reporte IV: Web service con aplicación Blacberry 10 como cliente
"Slug  : report-iv-bb10-web-service
"Cats  : Sin categoría
"Tags  : 
"=============================
"EditType   : post
"EditFormat : Markdown
"TextAttach : wpid1608-vimpress_5282e63f_mkd.txt
"========== Content ==========
...
Como este reporte forma parte de una serie de reportes, vamos a omitir la teoría sobre Web services puesto que ya se abordo en el reporte número <a href="/?p=865">II</a>.
...
- Qt 5 y Qt Creator, versiones beta (<a href="http://qt-project.org/downloads" target="_blank">http://qt-project.org/downloads</a>), solo descarga e instala con el clásico "Next, Next, Next...".
- El simulador de Blackberry (<a href="https://developer.blackberry.com/devzone/develop/simulator/simulator_installing.html" target="_blank">developer.blackberry.com/devzone/develop/simulator/simulator_installing.html</a>).

[php]subsection('Instalación del simulador');[/php]

El simulador es una imagen de disco que podemos usar con VMware Player (<a href="https://www.vmware.com" target="_blank">www.vmware.com</a>), simplemente instala VMware Player y carga la imagen del simulador.
...
[php]
figure('bbws_start_service_screen', 'El emulador no arranca', 'bbws_start_service_screen', 'png', 'ES');
[/php]
...
[php]
figure('bbws_start_service_screen_sol', 'Elige el modo seguro si no se cuenta con una tarjeta gráfica', 'bbws_start_service_screen_sol', 'png', 'ES');
[/php]


[php]subsection('Configuración de Qt Creator');[/php]
...
[php]
figure('bbws_qtcreator_qcc', 'Configuración del compilador para BlackBerry', 'bbws_qtcreator_qcc', 'png', 'ES');
[/php]

Ahora hay que configurar el simulador: Tool -> Options -> Devices -> Add...:

[php]
figure('bbws_qtcreator_add_sim_1', 'Agrega un nuevo dispositivo tipo BlackBerry', 'bbws_qtcreator_add_sim_1', 'png', 'ES');
[/php]

Especificamos la IP del simulador:

[php]
figure('bbws_qtcreator_add_sim_2', 'Detección del simulador', 'bbws_qtcreator_add_sim_2', 'png', 'ES');
[/php]

[php]
figure('bbws_qtcreator_add_sim_3', 'Detección del simulador', 'bbws_qtcreator_add_sim_3', 'png', 'ES');
[/php]

[php]
figure('bbws_qtcreator_add_sim_4', 'Detección del simulador', 'bbws_qtcreator_add_sim_4', 'png', 'ES');
[/php]

La IP la podemos encontrar en la parte inferior derecha del simulador:

[php]
figure('bbws_simulator_ip', 'IP del simulador', 'bbws_simulator_ip', 'png', 'ES');
[/php]

Ahora deberíamos poder probar una aplicación "¡Hola, mundo!":

[php] figure('bbws_hello_world_1', 'Nuevo proyecto, Paso 1', 'bbws_hello_world_1', 'png', 'ES'); [/php]
[php] figure('bbws_hello_world_2', 'Nuevo proyecto, Paso 2', 'bbws_hello_world_2', 'png', 'ES'); [/php]
[php] figure('bbws_hello_world_3', 'Nuevo proyecto, Paso 3', 'bbws_hello_world_3', 'png', 'ES'); [/php]
[php] figure('bbws_hello_world_4', 'Nuevo proyecto, Paso 4', 'bbws_hello_world_4', 'png', 'ES'); [/php]
[php] figure('bbws_hello_world_5', 'Nuevo proyecto, Paso 5', 'bbws_hello_world_5', 'png', 'ES'); [/php]
[php] figure('bbws_hello_world_6', 'Nuevo proyecto, Paso 6', 'bbws_hello_world_6', 'png', 'ES'); [/php]
...
[php]section('Desarrollo del servidor');[/php]
...
[php]subsection('El modelo de datos');[/php]

Nuestra base de datos consiste de 4 tablas, Cliente, Producto, Pedido y Detalle.

[php]
figure('bbws_data_model', 'Modelo de datos', 'bbws_data_model', 'png', 'ES');
[/php]
...
[php]subsection('Los servicios');[/php]
...
[php]section('La base de datos local');[/php]
...
- <del>**Key** Tabla auxiliar para almacenar las claves primarias de las tablas restantes.</del> Debido a las modificaciones ya no es necesaria.

[php]subsection('Inicialización de la base de datos');[/php]
...
[php]subsection('Operaciones con la base de datos');[/php]
...
[php]section('Comunicación con el Web service');[/php]
...
En el código anterior nos apoyamos de la clase <a href="https://qt-project.org/doc/qt-4.8/qxmlstreamreader.html" target="_blank">QXmlStreamReader</a> para extraer los valores.
...
[php]subsection('Registro de pedidos');[/php]

La siguiente imagen muestra la interfaz de usuario para registrar nuevos pedidos.

[php]
figure('bbws_app_shop', 'Registro de pedidos', 'bbws_app_shop', 'png', 'ES');
[/php]
...
[php]subsection('Consulta de pedidos');[/php]

Nuestra aplicación también permite consultar la lista de pedidos, aquí la interfaz:

[php]
figure('bbws_app_query', 'Consulta de pedidos', 'bbws_app_query', 'png', 'ES');
[/php]
...
El objeto *_requestModel* esta **enlazado** a un objeto <a href="http://developer.blackberry.com/native/reference/cascades/bb__cascades__listview.html" target="_blank">ListView</a> en la interfaz gráfica, por lo que los cambios que le ocurren al objeto *_requestModel* se reflejan automáticamente en el ListView.

[php]subsection('Subir los registros al servidor');[/php]
...
[php]
figure('bbws_app_upload', 'Envío de pedidos al servidor', 'bbws_app_upload', 'png', 'ES');
[/php]
...
[php]
figure('bbws_app_download', 'Actualización de catálogos', 'bbws_app_download', 'png', 'ES');
[/php]
...
add_bib('qt_project', 'Qt Project', 'Documentación de Qt', 'https://qt-project.org/');
generate_bib_table();
[/php]
